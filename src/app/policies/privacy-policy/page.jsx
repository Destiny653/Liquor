...
export default function Page() {
  return (
    <div>
      ...
      <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.nestorliquor.com (the “Site”).</p>
      <div>
        ...
        <ul>
          ...
          <li>- Bing: https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads
          </li>
        </ul>
        ...
        <div>
          <h1>Contact Us</h1>
          <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at info@nestorliquor.com or by mail using the details provided below:</p>
        </div>
        <div>
          <h3>Liquor Luxx</h3>
        </div>
