...
export default function BottomNav() {
    ...
    return (
        <div className='icon-parent'>
            ...
            <div onClick={()=>navigation.push('/register')} className="icon w-[35px] h-[35px] rounded-full flex items-center justify-center"><IoIosLogIn className="inline msgBtn" size={25} /></div>
